...
#def __init__(self, username, started, finished, correct, tries):
    ...
    def test_practise_started_with_level_given_correctly(self):
        ...
        self.assertEqual(self.trainee.practise_started_with_level(), {1:4, 2:1})    
    ...
    def test_practise_started_append(self):
        ...
        self.assertEqual(self.trainee.practise_started_with_level(), {1:4, 2:1, 3:1})
    ...
    def test_update_total_level(self):
        ...
        self.assertEqual(self.trainee.practise_started_with_level(), {1:4, 2:3})                

    def test_to_database(self):

        (username, started, finished, corrects, tries) = self.trainee.to_database()

        self.assertEqual((username, started, finished, corrects, tries), ("Testaaja", "1:4,2:1" , "1", 10, 20) )    